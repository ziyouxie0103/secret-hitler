...
void setup_and_visibility_for_five_players() {
    ...
    require(game.config()->hitler_knows_fascists, "Hitler should know fascists in five-player game");
    ...
    require(hitler_view->known_fascists.size() == 1U, "Hitler should see one fascist");
    require(hitler_view->known_fascists.front() == "2", "Hitler should see player 2 as fascist");
